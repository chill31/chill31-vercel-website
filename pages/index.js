    ...
    <div className="bg-[#2e353d] min-h-[700px] w-[100%] overflow-x-hidden flex flex-col gap-48 items-start justify-start selection:bg-[#454f5a]" id="container">
      ...
      <section className='w-[100%] min-h-[700px] relative pl-16 flex flex-col gap-16 max-skw:pl-8' id="projects">
        ...
        <div className='flex flex-wrap items-center justify-start relative -l-16 gap-10 pb-10'>
          ...
          <div onClick={() => { open("https://utility-text.vercel.app") }} className="group rounded-lg cursor-pointer p-10 bg-gray-900/50 flex flex-col gap-8 max-w-[calc(95vw-2.5rem)] w-[25rem] hover:!-translate-y-6 focus:!-translate-y-6 !transition-all outline-none max-h-[27rem] h-[27rem]" tabIndex="0">
          ...
          <div onClick={() => { open('https://chill31-todo.vercel.app') }} className="group rounded-lg cursor-pointer p-10 bg-gray-900/50 flex flex-col gap-8 max-w-[calc(95vw-2.5rem)] w-[25rem] hover:!-translate-y-6 focus:!-translate-y-6 !transition-all outline-none max-h-[27rem] h-[27rem]" tabIndex="0">
          ...
          <div onClick={() => { open('https://speed-readr.vercel.app') }} className="group rounded-lg cursor-pointer p-10 bg-gray-900/50 flex flex-col gap-8 max-w-[calc(95vw-2.5rem)] w-[25rem] hover:!-translate-y-6 focus:!-translate-y-6 !transition-all outline-none max-h-[27rem] h-[27rem]" tabIndex="0">
          ...
          <div onClick={() => { open('https://code-saver.vercel.app') }} className="group rounded-lg cursor-pointer p-10 bg-gray-900/50 flex flex-col gap-8 max-w-[calc(95vw-2.5rem)] w-[25rem] hover:!-translate-y-6 focus:!-translate-y-6 !transition-all outline-none max-h-[27rem] h-[27rem]" tabIndex="0">
          ...
          <div onClick={() => { open('https://country-info-murex.vercel.app') }} className="group rounded-lg cursor-pointer p-10 bg-gray-900/50 flex flex-col gap-8 max-w-[calc(95vw-2.5rem)] w-[25rem] hover:!-translate-y-6 focus:!-translate-y-6 !transition-all outline-none max-h-[27rem] h-[27rem]" tabIndex="0">
